...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create(Trace::TABLE, function (Blueprint $table) {
            ...
            $table->decimal(
                Trace::INCOME_EXCHANGE_RATE,
                9,
                4
            )->comment('入账汇率');
            
            $table->decimal(
                Trace::CLEARING_EXCHANGE_RATE,
                9,
                4
            )->comment('出账汇率');
            
            $table->decimal(Trace::INCOMING_RATE, 9, 4)->comment('进账费率');
            $table->decimal(Trace::CLEARING_RATE, 9, 4)->comment('出账费率');
